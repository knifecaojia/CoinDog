...
namespace OKCoinAPI
{
    public class OKCoin
    {
        ...
        static string api_secret { get; set; }

        int timeout;            
        int timezone;

        static string api_url = "https://www.okcoin.cn/";
        ...
        static TickerType tickerType = TickerType.LTC;
        ...
        public OKCoin(string _api_key, string _api_secret, int timeout = 5000, int timezone = 8)
        {
            api_key = _api_key;
        ...
        static string GET_API_URL(string api)
        {
            return string.Format("{0}{1}{2}?", api_url, api_ver, api);
        }
        ...
        static string GetActionUrl(string action)
        {
            ...
            switch (tickerType)
            {
                ...
                case TickerType.ETH: url = url + "symbol=eth_cny"; break;
            }
        ...
        /// </summary>
        /// <returns></returns>
        public static Ticker GetTicker(TickerType t=TickerType.BTC)
        {
            tickerType = t;
            Ticker result = null;
        ...
        JObject Post(string url, Dictionary<string, string> paramList)
        {
            ...
            string sign = System.Web.Security.FormsAuthentication.HashPasswordForStoringInConfigFile(data + "&secret_key=" + api_secret, "MD5").ToUpper();
            data += "&sign=" + sign;
